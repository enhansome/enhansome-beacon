# Awesome Bluetooth Beacon with stars
...
* [Eddystone Protocol Specification & Tools](https://github.com/google/eddystone) ⚠️ Archived
* [Eddystone Validator](https://github.com/google/eddystone/tree/master/tools/eddystone-validator) ⚠️ Archived
* [Eddystone Branding Guidelines](https://github.com/google/eddystone/tree/master/branding) ⚠️ Archived & [Logos](https://github.com/google/eddystone/tree/master/branding/assets) ⚠️ Archived
* \[Eddystone GATT Configuration Service & Google Nearby API and Proximity API]\(\* [](https://github.com/NordicSemiconductor/Android-nRF-Beacon-for-Eddystone) ⚠️ Archived) (by Nordic Semiconductor)
* [Google Developers Beacons Portal](https://developers.google.com/beacons/)
* Advertising frame types
  * [Eddystone-UID](https://github.com/google/eddystone/tree/master/eddystone-uid) ⚠️ Archived
  * [Eddystone-TLM](https://github.com/google/eddystone/tree/master/eddystone-tlm) ⚠️ Archived
  * [Eddystone-URL](https://github.com/google/eddystone/tree/master/eddystone-url) ⚠️ Archived
...
* [Physical Web Implementation Status](https://github.com/google/physical-web/blob/master/implementation-status.md) ⚠️ Archived
* [Physical Web Branding Guidelines](https://github.com/google/physical-web/blob/master/documentation/branding_guidelines.md) ⚠️ Archived & [Logos](https://github.com/google/physical-web/tree/master/documentation/images/logo) ⚠️ Archived
...
* [PunchClock](https://github.com/panicinc/PunchClock) ⚠️ Archived An in/out tracking app for iOS 7+ that uses iBeacon and Geofencing.
* [Google Glass & Beacons](https://github.com/tmwagency/Glasstimote) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2014-09-23
...
* [iOS & OSX Bluetooth library for RxSwift](https://github.com/Polidea/RxBluetoothKit) ⭐ 1,437 | 🐛 56 | 🌐 Swift | 📅 2024-03-05
...
* [Replicates detecting and broadcasting iBeacons in the background](https://github.com/Instrument/Vicinity) ⚠️ Archived
* [Generic iBeacon Management and Utilities by KinveyLabs](https://github.com/KinveyLabs/KCSIBeacon/) ⚠️ Archived
* [RABeaconManager](https://github.com/reelyactive/ble-ios-sdk) ⭐ 7 | 🐛 0 | 🌐 Objective-C | 📅 2017-01-23 RABeaconManager is an easy to use library that allows you to detect Bluetooth Beacons and iBeacons in the foreground and background.
...
* [iBeacon Scanner](https://play.google.com/store/apps/details?id=be.createweb.beaconscanner) & [code](https://github.com/eliaslecomte/ibeacon-scanner-app) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2019-11-06
...
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) ⭐ 27 | 🐛 0 | 🌐 Swift | 📅 2018-12-31 - Beacon detection framework ns Swift using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon, iBeacon.

# Linux

* [Python script for scanning and advertising urls over Eddystone-URL](https://github.com/forksociety/PyBeacon) ⚠️ Archived

# Node.js

* [A node.js BLE (Bluetooth low energy) central module](https://github.com/sandeepmistry/noble) ⚠️ Archived
* [A node.js module for implementing BLE (Bluetooth low energy) peripherals](https://github.com/sandeepmistry/bleno) ⚠️ Archived
...
* [BeaconCtrl](https://github.com/upnext/BeaconCtrl) ⭐ 92 | 🐛 16 | 🌐 Ruby | 📅 2016-04-15 Setup and manage large beacon deployments with BeaconCtrl Open Source platform
